...
`)+`
`+y);const P=D+S+h,U=D+y+p,H=Uv(l,l.VERTEX_SHADER,P),B=Uv(l,l.FRAGMENT_SHADER,U);l.attachShader(w,H),l.attachShader(w,B),n.index0AttributeName!==void 0?l.bindAttribLocation(w,0,n.index0AttributeName):n.morphTargets===!0&&l.bindAttribLocation(w,0,"position"),l.linkProgram(w);function z(F){if(r.debug.checkShaderErrors){const Y=l.getProgramInfoLog(w)||"",J=l.getShaderInfoLog(H)||"",st=l.getShaderInfoLog(B)||"",Q=Y.trim(),N=J.trim(),I=st.trim();let ct=!0,dt=!0;if(l.getProgramParameter(w,l.LINK_STATUS)===!1)if(ct=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(l,w,H,B);else{const Et=Nv(l,H,"vertex"),O=Nv(l,B,"fragment");be("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(w,l.VALIDATE_STATUS)+`
